    ...
    >
      ...
      <Link to={`/listings/${listing.id}`} className="block">
        ...
        <div className="relative h-52 bg-gradient-to-br from-primary-100 to-primary-200 dark:from-neutral-800 dark:to-neutral-900 overflow-hidden">
          ...
          {/* Gradient Overlay on Hover with "Detayları Gör" */}
          ...
          <motion.button
            ...
            className={`absolute top-3 right-3 z-20 w-10 h-10 rounded-full flex items-center justify-center backdrop-blur-md border transition-all duration-300 ${
              isFav 
                ? 'bg-red-500/90 border-red-400 text-white shadow-[0_0_15px_rgba(239,68,68,0.5)]' 
                : 'bg-black/30 border-white/20 text-white hover:bg-white hover:text-red-500'
            }`}
        ...
        <div className="p-5">
          ...
          <p className="text-neutral-600 dark:text-neutral-400 text-sm mb-4 line-clamp-2 leading-relaxed">
            {listing.description}
          </p>

          <div className="flex items-center justify-between pt-4 border-t border-neutral-100 dark:border-neutral-800">
            <div className="flex items-center gap-2 text-neutral-500 dark:text-neutral-500 text-xs">
